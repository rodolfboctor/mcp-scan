export const HIPAA_MAPPING = {
  ...
  controls: [
    { id: '164.308(a)(1)', description: 'Security Management Process', findingIds: ['malicious-package', 'supply-chain-malicious', 'known-vulnerability-critical'] },
    ...
    { id: '164.312(c)(1)', description: 'Integrity Controls', findingIds: ['config-drift', 'unauthorized-config-change', 'duplicate-server'] },
