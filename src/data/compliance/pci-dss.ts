export const PCI_DSS_MAPPING = {
  ...
  controls: [
    ...
    { id: 'Req 6', description: 'Protect Systems Against Attacks', findingIds: ['known-vulnerability-critical', 'known-vulnerability-high', 'malicious-package', 'supply-chain-malicious'] },
    ...
    { id: 'Req 12', description: 'Support Information Security Policies', findingIds: ['config-drift', 'unauthorized-config-change', 'typosquatting-package'] }
  ]
};
